...
#include "my_interfaces/srv/detail/move__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_interfaces::srv::Move_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_interfaces::srv::Move_Request & ros_message)
{
  // Member: linear_velocity
  cdr >> ros_message.linear_velocity;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_interfaces::srv::Move_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_interfaces::srv::Move_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_interfaces::srv::Move_Request *>(
    untyped_ros_message);
...
{
  return &my_interfaces::srv::typesupport_fastrtps_cpp::_Move_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interfaces, srv, Move_Request)() {
  return &my_interfaces::srv::typesupport_fastrtps_cpp::_Move_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_interfaces
cdr_serialize(
  const my_interfaces::srv::Move_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_interfaces::srv::Move_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_interfaces::srv::Move_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_interfaces::srv::Move_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_interfaces::srv::Move_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_interfaces::srv::typesupport_fastrtps_cpp::_Move_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interfaces, srv, Move_Response)() {
  return &my_interfaces::srv::typesupport_fastrtps_cpp::_Move_Response__handle;
}
...
{
  return &my_interfaces::srv::typesupport_fastrtps_cpp::_Move__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interfaces, srv, Move)() {
  return &my_interfaces::srv::typesupport_fastrtps_cpp::_Move__handle;
}
