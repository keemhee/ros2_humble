...
#include "my_interfaces/msg/detail/sensor_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_interfaces::msg::SensorStatus & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.debug_messages;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_interfaces::msg::SensorStatus & ros_message)
{
  // Member: temerature
  cdr >> ros_message.temerature;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_interfaces::msg::SensorStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_interfaces::msg::SensorStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_interfaces::msg::SensorStatus *>(
    untyped_ros_message);
...
{
  return &my_interfaces::msg::typesupport_fastrtps_cpp::_SensorStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interfaces, msg, SensorStatus)() {
  return &my_interfaces::msg::typesupport_fastrtps_cpp::_SensorStatus__handle;
}
