...
class Metaclass_Move(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from my_interfaces.srv import _move
...
class Move(metaclass=Metaclass_Move):
    from my_interfaces.srv._move import Move_Request as Request
    from my_interfaces.srv._move import Move_Response as Response
